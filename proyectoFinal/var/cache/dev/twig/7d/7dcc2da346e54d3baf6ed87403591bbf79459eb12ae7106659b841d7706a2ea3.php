...
class __TwigTemplate_cf56dd0e4ae31272af8704af38d34dcc7d2e24dd846cc274289cc827419d73f5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["tipo_productos"]) || array_key_exists("tipo_productos", $context) ? $context["tipo_productos"] : (function () { throw new RuntimeError('Variable "tipo_productos" does not exist.', 17, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tipo_producto"]) {
            ...
            echo "            <tr>
                <td>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tipo_producto"], "id", [], "any", false, false, false, 19), "html", null, true);
            echo "</td>
                <td>";
            // line 20
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tipo_producto"], "tipo", [], "any", false, false, false, 20), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("tipo_producto_show", ["id" => twig_get_attribute($this->env, $this->source, $context["tipo_producto"], "id", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 23
    ...
    <table class=\"table\">
        ...
        {% for tipo_producto in tipo_productos %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('tipo_producto_show', {'id': tipo_producto.id}) }}\">show</a>
