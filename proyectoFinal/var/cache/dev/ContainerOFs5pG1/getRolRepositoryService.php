 ...
 */
class getRolRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RolRepository' shared autowired service.
     *
     * @return \App\Repository\RolRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RolRepository.php';

        return $container->privates['App\\Repository\\RolRepository'] = new \App\Repository\RolRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
