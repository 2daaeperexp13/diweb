...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializerb406e && ($this->initializerb406e->__invoke($valueHolder16f96, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializerb406e) || 1) && $this->valueHolder16f96 = $valueHolder16f96;

        if ($this->valueHolder16f96 === $returnValue = $this->valueHolder16f96->paginate($target, $page, $limit, $options)) {
            return $this;
        }
