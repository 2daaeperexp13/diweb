 ...
 */
class getTarjetaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TarjetaRepository' shared autowired service.
     *
     * @return \App\Repository\TarjetaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TarjetaRepository.php';

        return $container->privates['App\\Repository\\TarjetaRepository'] = new \App\Repository\TarjetaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
