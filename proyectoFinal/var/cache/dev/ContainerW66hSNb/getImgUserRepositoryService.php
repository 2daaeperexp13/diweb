 ...
 */
class getImgUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ImgUserRepository' shared autowired service.
     *
     * @return \App\Repository\ImgUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ImgUserRepository.php';

        return $container->privates['App\\Repository\\ImgUserRepository'] = new \App\Repository\ImgUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
