 ...
 */
class getLocalidadRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LocalidadRepository' shared autowired service.
     *
     * @return \App\Repository\LocalidadRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LocalidadRepository.php';

        return $container->privates['App\\Repository\\LocalidadRepository'] = new \App\Repository\LocalidadRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
